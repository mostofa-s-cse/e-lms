  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        {/* Profile Header */}
        <div className="bg-gradient-to-r from-red-600 to-blue-600 px-6 py-8 text-white">
          <div className="flex items-center space-x-6">
            <div className="relative w-24 h-24 flex-shrink-0">
              ...
              <div className={`fallback absolute inset-0 w-24 h-24 rounded-full bg-gradient-to-br from-red-500 to-blue-600 flex items-center justify-center border-4 border-white ${
            ...
            <div className="mb-6">
              ...
              <div className="flex-shrink-0 items-center space-x-16">
                 <div className="flex-shrink-0 relative">
                  ...
                  <div className={`fallback absolute inset-0 w-14 h-14 rounded-full bg-gradient-to-br from-red-500 to-blue-600 flex items-center justify-center text-white font-semibold text-sm ${
              user.profile?.profilePicture ? 'hidden' : ''
            }`}>
