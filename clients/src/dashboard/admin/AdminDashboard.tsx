...
import EnrollmentApprovalsPage from './pages/enrollments/EnrollmentApprovalsPage';

const AdminDashboard = () => {
  const navigationItems = [
    { path: '/admin/users', label: 'Users', icon: <Users className="w-5 h-5" /> },
    { path: '/admin/approvals', label: 'User Approvals', icon: <ShieldUser className="w-5 h-5" /> },
    { path: '/admin/enrollment-approvals', label: 'Enrollment Approvals', icon: <UserCheck className="w-5 h-5" /> },
  ...
  const routes = (
    <>
      ...
      <Route path="enrollment-approvals" element={<EnrollmentApprovalsPage />} />
