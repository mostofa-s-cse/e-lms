...
exports.seedIntakes = seedIntakes;
async function seedIntakes(prisma, courses) {
    ...
    const intakes = await Promise.all(intakesData.map(intakeData => prisma.intake.create({
        data: intakeData
    })));
