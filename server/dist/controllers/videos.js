...
exports.deleteVideo = exports.updateVideo = exports.createVideo = exports.getVideosByTeacher = exports.getVideoById = exports.getVideosByCourse = exports.getAllVideos = void 0;
...
const getVideosByTeacher = async (req, res, next) => {
    try {
        ...
        res.json({ success: true, message: 'Teacher videos fetched successfully', data: videos });
    }
    catch (error) {
        next(error);
    }
};
exports.getVideosByTeacher = getVideosByTeacher;
