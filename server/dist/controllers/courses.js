...
exports.getCourseEnrollments = exports.deleteCourse = exports.updateCourse = exports.createCourse = exports.getCourseById = exports.getCoursesByTeacher = exports.getAllCourses = void 0;
...
const getCoursesByTeacher = async (req, res, next) => {
    try {
        ...
        res.json({ success: true, message: 'Teacher courses fetched successfully', data: courses });
    }
    catch (error) {
