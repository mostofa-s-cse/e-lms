...
exports.getNoteStats = exports.deleteNote = exports.updateNote = exports.createNote = exports.getNoteById = exports.getNotesByCourse = exports.getAllNotes = void 0;
    ...
    try {
        ...
        if (req.file) {
            ...
            if (existingNote.file) {
                const oldFilePath = path_1.default.join(__dirname, '..', '..', existingNote.file);
...
const deleteNote = async (req, res, next) => {
    try {
        ...
        if (existingNote.file) {
            const filePath = path_1.default.join(__dirname, '..', '..', existingNote.file);
