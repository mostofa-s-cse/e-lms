...
exports.getIntakeEnrollments = exports.deleteIntake = exports.updateIntake = exports.createIntake = exports.getIntakeById = exports.getIntakesByTeacher = exports.getAllIntakes = void 0;
...
const getIntakesByTeacher = async (req, res, next) => {
    try {
        ...
        res.json({ success: true, message: 'Teacher intakes fetched successfully', data: intakes });
    }
    catch (error) {
        next(error);
    }
};
exports.getIntakesByTeacher = getIntakesByTeacher;
